...
class DarkEnergyEqnOfState(DarkEnergyModel):
    ...
    _fields_ = [
        ...
        ("xi", c_double, "IDE coupling parameter (Q = xi*H*rho_de, default 0)"),
    ]
    "*****RU*****"
...
class DarkEnergyFluid(DarkEnergyEqnOfState):
    ...
    Supports optional interacting dark energy (IDE) coupling Q = xi*H*rho_de.
    Set xi=0 (default) for standard dark energy fluid.
    """
    ...
    def set_params(self, w=-1.0, wa=0.0, cs2=1.0, xi=0.0):
    ...
    def __init__(self, **kwargs):
        ...
        if abs(xi) > 1e-8:
            self.___is_cosmological_constant = False
            self.___num_perturb_equations = 2
    "*****RU*****"
    def validate_params(self) -> None:
